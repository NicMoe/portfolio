...
<i>
  ...
  . There was a plan to score and rank all proposed projects based on various factors
  to get the most public benefit out of the funds. However, there was a core issue
  I identified with the proposed scoring calculations and raised to the focus group
  organizers and the city council. This report is what I used to explain the issue
  and present a simplication to the scoring process to yield considerably greater
  value.
</i>
