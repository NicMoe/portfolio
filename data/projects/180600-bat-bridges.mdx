...
name: Bat bridges
type: project
description: How civil infrastructure can affect human health by way of bats
color: '#161616'
...
<figure>
  <center>
    <img src="bat-bridge.png" width="350" alt="Underside of highway bridge with visible, parellel cracks designed to create bat habitat."/><br>
    <small><i>The underside of the McNeil bridge off I-35 in Round Rock, Texas, was modeled with a ~1" spacing between concrete beams to allow for free-tailed bats to move in. This bridge is currently home to 1.5 million of these bats.</i></small>
  </center>
</figure>
