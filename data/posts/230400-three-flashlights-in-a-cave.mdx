---
name: Building a resilient data team
type: project
...
As an analogy for a well-staffed team, I believe <b>any core function of a team should be familiar to at least three team members</b> so that if one goes on vacation, and another goes on parental leave, there’s always at least one person who can do the job. As well, multiple people knowing how to work on any core responsibility guarantees oversight for each piece, enables team collaboration, and gives the team a framework to share and expand their skills.
